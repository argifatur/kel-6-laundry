...
if(isset($_POST['add'])) {
    ...
    $sql = mysqli_query($conn, "UPDATE transaksi SET tgl_bayar = '$tanggal_bayar', status_pembayaran = '$status_pembayaran', dibayar = $dibayar, status_pesanan = '$status_pesanan' WHERE kode_transaksi = '$id'");
    if($sql) {
...
<div class="info">
  <form method="POST" action="">
    ...
    <div class="form-group">
      ...
      <input type="number" name="nilai_laundry" value="<?= $show['nilai_laundry'] ?>" class="form-control">
    </div>

    <div class="form-group">
      <label>Dibayar :</label>
      <input type="number" name="dibayar" value="<?= $show['dibayar'] ?>" class="form-control">
    </div>
