...
<div class="right">
  <a href="petugas.php" class="btn btn-warning" style="margin-top: 10px;">Kembali</a>
  <input type="submit" name="add" value="Tambah Petugas" class="btn btn-primary btn-user btn-block" style="margin-top: 10px; margin-right: 5px;">
</div>
